...
function em1(){var c="benjoAipemufybt/dpn";var addr="mailto:";for(var i=0;i<c.length;i++)addr+=String.fromCharCode(c.charCodeAt(i)-1);window.location.href=addr;}
...
wl=new woolite();
wl.init();
wl.addAnimation($('.js1')[0], "3.40s", "0.00s", 1, 100);
wl.start();
